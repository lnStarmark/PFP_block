...
if (OPSYS == "WIN"):
    PATH_CONFIG = 'config\\Config_OOP_wincreator.ini'
    PATH_XLSX = "xlsx\\OOP_wincreator"
...
class App(ttk.Frame):
    ...
    def __init__(self,master=None):
        ...
        self.pan01 = self.Pan(self.pan0, tk.LEFT, tk.BOTH, "nw", self.BAZE_X/3-2*self.PADDING, self.BAZE_Y-2*self.PADDING)
        if(self.COMMON_LABEL == 'True' and self.ALL_LABEL == 'True'):            
            self.lab01 = self.Lab(self.pan01, tk.TOP, tk.X, "nw", "panel 01")
        
        self.pan02 = self.Pan(self.pan0, tk.LEFT, tk.BOTH, "nw", 2*self.BAZE_X/3-2*self.PADDING, self.BAZE_Y-2*self.PADDING)
        if(self.COMMON_LABEL == 'True'  and self.ALL_LABEL == 'True'):            
            self.lab02 = self.Lab(self.pan02, tk.TOP, tk.X, "nw", "panel 02")
        
        
        self.pan011 = self.Pan(self.pan01, tk.TOP, tk.BOTH, "nw", self.BAZE_X/3-2*self.PADDING, 5*self.BAZE_Y/8-2*self.PADDING)
        ...
        self.pan012 = self.Pan(self.pan01, tk.TOP, tk.BOTH, "nw", self.BAZE_X/3-2*self.PADDING, 3*self.BAZE_Y/8-2*self.PADDING)
        if(self.ALL_LABEL == 'True'):
            self.lab012 = self.Lab(self.pan012, tk.TOP, tk.X, "nw", "panel 012")
        self.pan0121 = self.Pan(self.pan012, tk.TOP, tk.BOTH, "nw", self.BAZE_X/3-4*self.PADDING, 3*self.BAZE_Y/8-4*self.PADDING)
        
        
        self.pan021 = self.Pan(self.pan02, tk.TOP, tk.BOTH, "nw", 2*self.BAZE_X/3-2*self.PADDING, self.BAZE_Y/4-2*self.PADDING)
        if(self.ALL_LABEL == 'True'):
            self.lab021 = self.Lab(self.pan021, tk.TOP, tk.X, "nw", "panel 021")
        self.pan0211 = self.Pan(self.pan021, tk.TOP, tk.BOTH, "nw", 2*self.BAZE_X/3-4*self.PADDING, self.BAZE_Y/4-4*self.PADDING)
        
        self.pan022 = self.Pan(self.pan02, tk.TOP, tk.BOTH, "nw", 2*self.BAZE_X/3-2*self.PADDING, 3*self.BAZE_Y/4-2*self.PADDING)
        if(self.COMMON_LABEL == 'True'):
            self.lab022 = self.Lab(self.pan022, tk.TOP, tk.X, "nw", "panel 022")
        self.pan0221 = self.Pan(self.pan022, tk.TOP, tk.BOTH, "nw", 2*self.BAZE_X/3-4*self.PADDING, 3*self.BAZE_Y/4-4*self.PADDING)  
        

        self.pan0222 = self.Pan(self.pan0221, tk.LEFT, tk.BOTH, "nw", (2*self.BAZE_X/3)/2-4*self.PADDING, 3*self.BAZE_Y/4-4*self.PADDING)
        if(self.ALL_LABEL == 'True'):
        ...
        self.pan0223 = self.Pan(self.pan0221, tk.LEFT, tk.BOTH, "nw", (2*self.BAZE_X/3)/2-4*self.PADDING, 3*self.BAZE_Y/4-4*self.PADDING)
        if(self.ALL_LABEL == 'True'):
            self.lab0223 = self.Lab(self.pan0223, tk.TOP, tk.X, "nw", "panel 0223")
    
        self.pan02231 = self.Pan(self.pan0223, tk.LEFT, tk.BOTH, "nw", (2*self.BAZE_X/3)/2-8*self.PADDING, 3*self.BAZE_Y/4-8*self.PADDING)  
